...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2020 at 12:57 PM
...
(1, '2017-11-20-223112', 'Myth\\Auth\\Database\\Migrations\\CreateAuthTables', 'default', 'Myth\\Auth', 1608119840, 1),
(2, '2020-12-15-081221', 'App\\Database\\Migrations\\Kelas', 'default', 'App', 1608119840, 1),
(3, '2020-12-15-113612', 'App\\Database\\Migrations\\Mahasiswa', 'default', 'App', 1608119840, 1),
(4, '2020-12-15-113619', 'App\\Database\\Migrations\\Kehadiran', 'default', 'App', 1608119840, 1);
...
ALTER TABLE `kehadiran`
  ...
  ADD KEY `kehadiran_kelas_id_foreign` (`kelas_id`);
...
--
ALTER TABLE `mahasiswa`
  MODIFY `mahasiswa_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `kehadiran`
  ADD CONSTRAINT `kehadiran_kelas_id_foreign` FOREIGN KEY (`kelas_id`) REFERENCES `kelas` (`kelas_id`),
